...
#
# Generated by export_simulation on Thu Mar 17 19:59:16 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './quantum_dot_simulator_0.sh' script.

./quantum_dot_simulator_0.sh -reset_run
...
./quantum_dot_simulator_0.sh -noclean_files

For more information on the script, please type './quantum_dot_simulator_0.sh -help'.
